/**
 * Obstacle Atlas Generation (Session 130)
 *
...
export const createObstacleAtlas = (): AtlasResult | null => {
  ...
  for (let i = -numStripes; i < numStripes; i++) {
    ...
    ctx.fillStyle = i % 2 === 0 ? OBSTACLE_CONFIG.stripeColor1 : OBSTACLE_CONFIG.stripeColor2;
    ctx.fillRect(
  ...
  // The obstacle texture is a single image (no UV mapping needed)
  // It will be stretched to fit each obstacle's radius
