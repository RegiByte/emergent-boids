...
import { profilerKeywords, roleKeywords } from '../vocabulary/keywords'
import type {
  BehaviorContext,
  BehaviorRuleset,
  BehaviorScore,
...
export function buildBehaviorContext(
  ...
  const environmentPressure = Math.max(0, (context.populationRatio - 0.7) / 0.3)
